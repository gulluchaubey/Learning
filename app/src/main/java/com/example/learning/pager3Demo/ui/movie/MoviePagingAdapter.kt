...
import com.example.learning.pager3Demo.data.Movie
import com.example.learning.databinding.AdapterMovieBinding
...
class MoviePagingAdapter : PagingDataAdapter<Movie,MoviePagingAdapter.MyViewHolder>(DIFF_UTILS){
    ...
    inner class MyViewHolder(val viewDataBinding : AdapterMovieBinding):RecyclerView.ViewHolder(viewDataBinding.root)
